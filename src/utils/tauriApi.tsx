 ...
 * @returns
 */
export async function focusApi(windowName: string) {
  const returnCode = await callTauriApi('focus_window_handler', { windowName });
  return returnCode === 0 ? 0 : Promise.reject(returnCode);
}
